...
//
// Transparent motionblur environment shading demonstration
//
#include "lib/types.h"
...
char		backdropfile[]	= "assets/backdrop.raw";
word		vscreen, enviromap, backdrop, alpha;
...
void	drawframe ( void ) {
	...
	drawfacets ();
	motionblur (alpha, backdrop, vscreen, 1);
}
...
void	main ( void ) {
	...
	clrscr ();
	printf ( "\n" );
	printf ( "Transparent motionblur environment shading demonstration\n\n" );
	...
	alpha = initvirtual (65536);
	backdrop = initpicture (backdropfile);
